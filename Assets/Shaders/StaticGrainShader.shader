Shader "Custom/StaticGrainEffect"
{
    Properties
    {
        ...
        _ColorDampening("Color Dampening", Range(0, 1)) = 0.5 // Dampens the intensity of the light colour at the edges
        ...
        SubShader
        {
            ...
            // Calculate luminance (brightness) of a colour
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                // Initialize grain-specific light intensity and colour
                ...
                // Dampen the grain light colour at the edges of the grain effect
                ...
                // Blend grain colour between base texture colour (black static) and the dampened grain light colour
